...
class TestCLI:
    ...
    def test_read_command_success(self, capsys):
    ...
    def test_read_command_error(self, capsys):
    ...
    def test_sample_command_json(self, capsys):
    ...
    def test_sample_command_text(self, capsys):
    ...
    def test_span_command(self, capsys):
    ...
    def test_abc_enable_command(self, capsys):
    ...
    def test_abc_disable_command(self, capsys):
    ...
    def test_keyboard_interrupt_sample_json(self, capsys):
